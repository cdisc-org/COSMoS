...
%let ExcelFile=&root/curation/BC_Package_R11_VS.xlsx;
...
%let ExcelFile=&root/curation/BC_Package_R11_AE_Edit.xlsx;
%generate_yaml_from_bc_sdtm(excel_file=&Excelfile, type=ae, package=&package, override_package_date=&OverrideDate, out_folder=&TargetFolder, subsetsDS=subsets, range=%str(SDTM_AE), debug=0, check_relationships=&checkrelationships);
