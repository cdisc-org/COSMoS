...
linkml_meta = LinkMLMeta({'default_prefix': 'cosmos_sdtm',
     ...
     'source_file': '../model/cosmos_sdtm_model.yaml'} )
...
class LinkingPhraseEnum(str, Enum):
    ...
    indicates_the_location_detail_for_the_tumor_identified_by = "indicates the location detail for the tumor identified by"
    ...
    is_the_reason_for_the_status_of_the_value_in = "is the reason for the status of the value in"
    is_the_reason_the_lesion_was_not_evaluable_in = "is the reason the lesion was not evaluable in"
    ...
    is_the_status_of_the_value_in = "is the status of the value in"
