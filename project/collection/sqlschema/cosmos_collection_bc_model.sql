...
-- # Class: SDTMTarget_sdtmVariables
...
);CREATE INDEX "ix_DataCollectionGroup_collectionSpecializationId" ON "DataCollectionGroup" ("collectionSpecializationId");
CREATE TABLE "PrepopulatedValue" (
	id INTEGER NOT NULL,
	value TEXT NOT NULL,
	"conceptId" TEXT,
	PRIMARY KEY (id)
);CREATE INDEX "ix_PrepopulatedValue_id" ON "PrepopulatedValue" (id);
CREATE TABLE "CodeList" (
	...
	href TEXT,
	PRIMARY KEY (id)
);CREATE INDEX "ix_CodeList_id" ON "CodeList" (id);
CREATE TABLE "SDTMTarget" (
	id INTEGER NOT NULL,
	"sdtmAnnotation" TEXT,
	"sdtmTargetMapping" TEXT,
	PRIMARY KEY (id)
);CREATE INDEX "ix_SDTMTarget_id" ON "SDTMTarget" (id);
...
);CREATE INDEX "ix_DataCollectionItem_name" ON "DataCollectionItem" (name);
CREATE TABLE "SDTMTarget_sdtmVariables" (
	"SDTMTarget_id" INTEGER,
	"sdtmVariables" TEXT,
	PRIMARY KEY ("SDTMTarget_id", "sdtmVariables"),
	FOREIGN KEY("SDTMTarget_id") REFERENCES "SDTMTarget" (id)
);CREATE INDEX "ix_SDTMTarget_sdtmVariables_sdtmVariables" ON "SDTMTarget_sdtmVariables" ("sdtmVariables");CREATE INDEX "ix_SDTMTarget_sdtmVariables_SDTMTarget_id" ON "SDTMTarget_sdtmVariables" ("SDTMTarget_id");
...
);CREATE INDEX "ix_ListValue_id" ON "ListValue" (id);
