...
REM call gen-project -d ../project/bc ../model/cosmos_bc_model.yaml
call gen-doc .\model\cosmos_bc_model.yaml --directory project/bc/docs/ --subfolder-type-separation --hierarchical-class-view --diagram-type er_diagram --sort-by rank --include-top-level-diagram --truncate-descriptions false
