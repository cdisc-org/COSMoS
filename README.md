...
- **export**
  ...
  - [Latest CRF Specializations (DRAFT)](export/cdisc_crf_specializations_draft.xlsx) (Excel spreadsheet)
  - [Latest CRF Specializations (DRAFT)](export/cdisc_crf_specializations_draft.csv) (CSV)
